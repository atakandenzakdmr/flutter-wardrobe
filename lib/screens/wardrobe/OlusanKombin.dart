...
class OlusanKombin extends StatelessWidget {
  OlusanKombin({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(126.0, 44.0, 139.0, 27.0),
                  size: Size(375.0, 90.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(7.0, 0.0, 138.0, 24.0),
                  ...
                  Pinned.fromSize(
                    ...
                    child: SingleChildScrollView(
                        child: Text(
                      '\n\nKombin üzerinde değişiklikler yapmak için Kombin Oluştur\'a dönebilirsin.\n',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 20,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(30.0, 17.0, 131.0, 161.0),
                    size: Size(197.0, 245.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Container(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 197.0, 245.0),
                    size: Size(197.0, 245.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(3.0, -4.0, 109.0, 142.0),
                    size: Size(122.0, 117.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 122.0, 117.0),
                    size: Size(122.0, 117.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 137.0, 21.0),
                      size: Size(163.3, 21.0),
                      pinLeft: true,
                      pinTop: true,
                      pinBottom: true,
                      fixedWidth: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(142.0, 0.0, 21.3, 16.2),
                      size: Size(163.3, 21.0),
                      pinRight: true,
                      pinTop: true,
                      fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 83.0, 17.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 44.0, 155.0, 20.0),
                    size: Size(333.0, 79.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 140.0, 17.0),
                    size: Size(140.0, 118.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 31.0, 87.0, 87.0),
                    size: Size(140.0, 118.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 135.0, 17.0),
                    size: Size(135.0, 119.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(29.0, 32.0, 87.0, 87.0),
                    size: Size(135.0, 119.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(13.0, 6.0, 61.0, 75.0),
                                size: Size(87.0, 87.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
...
const String _svg_bydnzu =
    '<svg viewBox="-2.5 253.5 378.0 1.0" ><path transform="translate(-2.5, 253.5)" d="M 0 0 L 378 0" fill="none" stroke="#ebebeb" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
