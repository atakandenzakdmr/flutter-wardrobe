...
class HaberIcerigi extends StatelessWidget {
  HaberIcerigi({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 78.0, 354.0, 542.0),
                    size: Size(354.0, 620.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Text.rich(
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                '\n\n\n\n\n\n\n\n\nKanadalı ünlü sanatçı Justin Bieber\'ın tercihi Les \nBenjamins oldu\nLes Benjamins Sonbahar Kış 2020 koleksiyonu \ntasarımlarını tercih eden Justin Bieber, yeni yıl özel \ngösteriminin provalarından fotoğraf ve videolarını \nInstagram hesabından paylaştı.\n\nİstanbul merkezli lüks sokak giyim markası Les \nBenjamins daha önce Jay-Z, Rita Ora, Barbara Palvin, \nJared Leto gibi dünyaca ünlü isimlerin de tercihi \nolmuştu.\n\nLes Benjamins’in Anadolu rock kültüründen ilham alan \nSonbahar/Kış 2021 koleksiyonu, \n',
                          ),
                          TextSpan(
                            text: 'www.lesbenjamins.com',
                            style: TextStyle(
                          ...
                          TextSpan(
                            text:
                                ' , Les Benjamins Nişantaşı \nmağazası ve seçili noktalarda satışta.\n',
                          ),
                        ],
                      ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(50.0, 43.0, 233.0, 206.0),
                    size: Size(354.0, 620.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(36.0, 0.0, 278.0, 54.0),
                    size: Size(354.0, 620.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
