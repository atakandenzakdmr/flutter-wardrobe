...
import './HaberTakibi.dart';
import 'package:adobe_xd/page_link.dart';
import './HaberTakibi2.dart';
...
class HaberSec extends StatelessWidget {
  HaberSec({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 78.0, 334.0, 513.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: SingleChildScrollView(
                      ...
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                'Vogue, New York\'ta bulunan moda, güzellik, kültür, yaşam ve pist gibi birçok konuyu kapsayan bir Amerikan aylık moda ve yaşam tarzı dergisidir. \n \n\nVogue, ilk kez 1892\'de Amerika Birleşik Devletleri\'nde New York\'ta yayınlanan, yıllar sonra aylık bir yayın haline gelmeden önce haftalık bir gazete olarak başladı.\n\nİngiliz Vogue 1916\'da piyasaya sürülen ilk uluslararası baskı iken, İtalyan versiyonu Vogue Italia dünyanın en iyi moda dergisi olarak adlandırıldı.\n\n\nBugün itibarıyla 23 uluslararası basım var.\n\n\n',
                          ),
                          TextSpan(
                            text: 'https://vogue.com.tr/\n\n',
                            style: TextStyle(
                              color: const Color(0xff1a45ce),
                            ),
                          ),
                          TextSpan(
                            text:
                                '\nHaberdar olmak için markayı takip edebilirsin!\n',
                          ),
                        ],
                      ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 403.0, 87.0, 24.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 476.0, 92.0, 24.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(273.0, 0.0, 48.0, 48.0),
                    size: Size(336.0, 595.0),
                    pinRight: true,
                    pinTop: true,
                    fixedWidth: true,
                    ...
                    child:
                      ...
                      child: Stack(
                        children: <Widget>[
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    ...
                                    const Color(0xfff1a49f),
                                    const Color(0xfff93995),
                                    const Color(0xffeb47c7),
                                    const Color(0xffcc4ae4),
                                    const Color(0xffb295f2),
                                    const Color(0xff110e0d)
                                  ],
                                  stops: [
                                    0.0,
                                    0.164,
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(15.0, 17.0, 17.6, 13.4),
                            size: Size(48.0, 48.0),
                            fixedWidth: true,
                            fixedHeight: true,
                            child:
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 535.0, 276.0, 60.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(1.0, 173.0, 42.0, 24.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(262.0, 53.0, 70.0, 17.0),
                    size: Size(336.0, 595.0),
                    pinRight: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 18.0, 116.0, 30.0),
                    size: Size(336.0, 595.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
...
const String _svg_pmc1r8 =
    '<svg viewBox="179.0 380.0 17.6 13.4" ><defs><linearGradient id="gradient" x1="0.5" y1="0.0" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#ffdee4f5"  /><stop offset="0.163911" stop-color="#fff1a49f"  /><stop offset="0.445083" stop-color="#fff93995"  /><stop offset="0.679445" stop-color="#ffeb47c7"  /><stop offset="0.829993" stop-color="#ffcc4ae4"  /><stop offset="0.963938" stop-color="#ffb295f2"  /><stop offset="1.0" stop-color="#ff3d0ff6"  /><stop offset="1.0" stop-color="#ff110e0d"  /></linearGradient></defs><path transform="translate(175.6, 374.4)" d="M 9 16.20000076293945 L 7.900000095367432 15.10000038146973 L 4.800000190734863 12 L 3.400000095367432 13.39999961853027 L 9 19 L 21 7 L 19.60000038146973 5.599999904632568 L 9 16.20000076293945 Z" fill="url(#gradient)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_91u2zw =
    '<svg viewBox="179.0 380.0 17.6 13.4" ><path transform="translate(175.6, 374.4)" d="M 9 16.20000076293945 L 7.900000095367432 15.10000038146973 L 4.800000190734863 12 L 3.400000095367432 13.39999961853027 L 9 19 L 21 7 L 19.60000038146973 5.599999904632568 L 9 16.20000076293945 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
