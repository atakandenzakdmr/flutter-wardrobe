...
class DolabimPantolon extends StatelessWidget {
  DolabimPantolon({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: Text(
              'Dolabınızda 8 Adet Pantolon var ',
              style: TextStyle(
                fontFamily: 'SF Pro Text',
                fontSize: 18,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 105.0, 24.0),
                    size: Size(105.0, 24.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(22.2, 10.4, 98.2, 121.0),
                          size: Size(146.0, 146.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(-5.4, 0.1, 146.0, 146.0),
                          size: Size(146.0, 146.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(34.0, 8.0, 68.0, 109.0),
                          size: Size(146.0, 146.0),
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 1.7, 146.0, 146.0),
                          size: Size(146.0, 146.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
          ...
          Transform.translate(
            offset: Offset(21.0, 558.0),
            child:
                // Adobe XD layer: 'indir (1)' (shape)
                Container(
              width: 146.0,
              height: 146.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(200.0, 558.0),
            child:
                // Adobe XD layer: 'indir (2)' (shape)
                Container(
              width: 146.0,
              height: 146.0,
              decoration: BoxDecoration(
