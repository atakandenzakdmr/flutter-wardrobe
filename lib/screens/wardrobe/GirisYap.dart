import 'package:firebaseasvine/screens/wardrobe/Gardrobe.dart';
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(112.0, 19.0, 56.0, 16.0),
                      size: Size(279.0, 52.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 63.0, 17.0),
                  ...
                  Pinned.fromSize(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1.0, color: const Color(0xb7000000)),
                      ),
                    ),
                  ),
                  Pinned.fromSize(
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 40.0, 17.0),
                    size: Size(333.0, 79.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(68.5, 0.0, 86.0, 28.0),
                    size: Size(154.5, 28.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
