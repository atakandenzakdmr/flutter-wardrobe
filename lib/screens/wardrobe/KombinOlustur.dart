...
class KombinOlustur extends StatelessWidget {
  KombinOlustur({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(19.0, 53.0, 18.0, 18.0),
                  size: Size(375.0, 90.0),
                  pinLeft: true,
                  fixedWidth: true,
                  fixedHeight: true,
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(116.0, 44.0, 143.0, 27.0),
                  size: Size(375.0, 90.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 181.0, 17.0),
                    size: Size(386.0, 170.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'Eşleştirilecek Alt Giyim ',
                      style: TextStyle(
                        fontFamily: 'Arial',
                        fontSize: 16,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 77.0, 384.0, 93.0),
                    size: Size(386.0, 170.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                              ...
                              Pinned.fromSize(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(13.0, 6.0, 61.0, 75.0),
                                      size: Size(87.0, 87.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
                              ...
                              Pinned.fromSize(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    ...
                                    Pinned.fromSize(
                                      bounds: Rect.fromLTWH(6.0, 7.0, 9.5, 7.2),
                                      size: Size(21.0, 21.0),
                                      fixedWidth: true,
                                      fixedHeight: true,
                                      child:
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(197.0, 6.0, 87.0, 87.0),
                          size: Size(384.0, 93.0),
                          pinTop: true,
                          pinBottom: true,
                          fixedWidth: true,
                              ...
                              Pinned.fromSize(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(20.0, 5.0, 48.0, 76.0),
                                      size: Size(87.0, 87.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 181.0, 60.0),
                    size: Size(386.0, 222.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 135.0, 87.0, 87.0),
                    size: Size(386.0, 222.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(-5.0, -10.0, 96.0, 107.0),
                                size: Size(87.0, 87.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(100.0, 135.0, 88.0, 87.0),
                    size: Size(386.0, 222.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(199.0, 135.0, 87.0, 87.0),
                    size: Size(386.0, 222.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 1.0, color: const Color(0xfff1a19c)),
                            ),
                          ),
                        ),
                        Pinned.fromSize(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(299.0, 135.0, 87.0, 87.0),
                    size: Size(386.0, 222.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(7.0, 0.0, 160.0, 24.0),
                    size: Size(350.0, 138.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 24.0, 350.0, 114.0),
                    size: Size(350.0, 138.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Text(
                      '\n\nÜst Giyim ve Alt Giyim kategorilerinden en az 1 ürün seçmeyi unutma!',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 20,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(222.0, 29.0, 113.3, 21.0),
                    size: Size(350.0, 138.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => OlusanKombin(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(0.0, 0.0, 87.0, 21.0),
                            size: Size(113.3, 21.0),
                            pinLeft: true,
                            pinTop: true,
                            pinBottom: true,
                            fixedWidth: true,
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(92.0, 0.0, 21.3, 16.2),
                            size: Size(113.3, 21.0),
                            pinRight: true,
                            pinTop: true,
                            fixedWidth: true,
