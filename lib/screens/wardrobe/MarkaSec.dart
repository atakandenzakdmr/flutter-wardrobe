...
class MarkaSec extends StatelessWidget {
  MarkaSec({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 0.0, 157.0, 41.0),
                    size: Size(336.0, 591.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    ...
                    child: SingleChildScrollView(
                      ...
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                'Colin\'s, Eroğlu grubunun bir parçasıdır . Şirketin genel merkezi İstanbul , Türkiye\'de bulunmaktadır. Uygun fiyatlı orta fiyatlı bir kategoride kıyafet sağlamayı amaçlamaktadır.\n\n \nColin\'s, 1983 yılında yağmurluk ve ceket üretimi yapan bir şirket olarak Türkiye\'de kurulmuştur .  1992\'de Colin\'s markası altında endüstriyel bir giyim firması haline getirilmiştir. 1993 yılında Türkiye dışında ilk mağazasını açarak uluslararası pazara girmiştir .\n\n\nColin\'s  ürünleri şu anda Belarus dahil 32 ülkede temsil ediliyor .\n\n\n',
                          ),
                          TextSpan(
                            text: 'www.colinsjeans.com\n\n',
                            style: TextStyle(
                          ...
                          TextSpan(
                            text:
                                '\nModayı doyasıya takip etmek senin hakkın.\nEn yeni katalog çekimlerinden haberdar olmak\niçin markayı takip edebilirsin!\n',
                          ),
                        ],
                      ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 343.0, 87.0, 24.0),
                    size: Size(336.0, 591.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 427.0, 92.0, 24.0),
                    size: Size(336.0, 591.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(2.0, 488.0, 101.0, 24.0),
                    size: Size(336.0, 591.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
