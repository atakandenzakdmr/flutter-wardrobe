...
class DolabimBlazer extends StatelessWidget {
  DolabimBlazer({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(9.0, 59.0, 146.0, 146.0),
                    size: Size(330.0, 417.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds:
                                    Rect.fromLTWH(-8.0, -14.1, 131.2, 146.0),
                                size: Size(146.0, 146.0),
                                pinLeft: true,
                                pinTop: true,
                                pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(184.0, 59.0, 146.0, 146.0),
                    size: Size(330.0, 417.0),
                    pinRight: true,
                    pinTop: true,
                    fixedWidth: true,
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(-5.0, -3.0, 150.0, 184.0),
                                size: Size(146.0, 146.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(-1.7, 0.0, 146.0, 146.0),
                          size: Size(146.0, 146.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                ...
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(-3.4, 0.0, 88.0, 88.0),
                          size: Size(146.0, 146.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, -0.5, 146.0, 146.0),
                          size: Size(146.0, 146.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
