...
class ModaRehberi extends StatelessWidget {
  ModaRehberi({
    Key key,
  }) : super(key: key);
  @override
          ...
          SizedBox(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromSize(
                  bounds: Rect.fromLTWH(124.0, 44.0, 128.0, 27.0),
                  size: Size(375.0, 90.0),
                  fixedWidth: true,
                  fixedHeight: true,
                  child: Text(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.5, 49.0, 335.0, 105.5),
                    size: Size(355.0, 403.5),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.5, 162.0, 354.5, 101.5),
                    size: Size(355.0, 403.5),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.5, 281.0, 343.5, 122.5),
                    size: Size(355.0, 403.5),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(112.5, 0.0, 217.0, 54.0),
                          size: Size(343.5, 122.5),
                          pinRight: true,
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
                            'GALERİ\' ERDEM X H&M İLK KEZ GÖRÜCÜYE ÇIKTI',
                            style: TextStyle(
                              fontFamily: 'SF Pro Text',
                              fontSize: 15,
                              color: const Color(0xff252525),
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(112.5, 40.0, 231.0, 82.0),
                          size: Size(343.5, 122.5),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                          child: Text(
                            'Ünlü fotoğrafçı Michal Pudelka, fotoğrafladığı koleksiyonda, Erdem’in güzellik diyalektiğini yansıttığı kendine has bir look book yarattı.',
                            style: TextStyle(
                              fontFamily: 'SF Pro Text',
                              fontSize: 13,
                              color: const Color(0xff777777),
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 122.5, 335.0, 1.0),
                          size: Size(343.5, 122.5),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.5, 11.0, 95.0, 90.0),
                          size: Size(343.5, 122.5),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 336.0, 24.0),
                    size: Size(355.0, 403.5),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(253.0, 3.0, 83.0, 21.0),
                          size: Size(336.0, 24.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 46.0, 241.0, 142.0),
                    size: Size(504.0, 188.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: '93ed8df6-3a48-4b6a-…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: const AssetImage(''),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(263.0, 46.0, 241.0, 141.0),
                    size: Size(504.0, 188.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'kivanc-tatlitug-mav…' (shape)
                        Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: const AssetImage(''),
...
const String _svg_7iqts4 =
    '<svg viewBox="20.5 293.0 335.0 1.0" ><path transform="translate(20.5, 292.98)" d="M 0 0 L 335 0" fill="none" stroke="#ebebeb" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
